...
contract MarketFactory {
    ...
    mapping(address => bool) isDeployedByFactory;

    function MarketFactory(){

    }

    function isDeployedByFactory(address contractAddress) public view returns (bool) {
        return isDeployedByFactory[contractAddress];
    }
